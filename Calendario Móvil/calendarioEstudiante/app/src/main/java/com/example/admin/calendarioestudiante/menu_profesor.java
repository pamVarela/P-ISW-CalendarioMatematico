...
public class menu_profesor extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foto = findViewById(R.id.fotoProfe);
        nombre = findViewById(R.id.nombreProfesor);

        final ImageButton cursos = findViewById(R.id.cursos);
        final ImageButton salir = findViewById(R.id.salir);
        final ImageButton acercaApp = findViewById(R.id.acercaApp);
        ...
        cursos.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent(menu_profesor.this,cursosProfesor.class);
                FirebaseUser mUser = auth.getCurrentUser();
                intent.putExtra("correo",mUser.getEmail());
        ...
        acercaApp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(menu_profesor.this,acercaApp.class);
                startActivity(intent);
            }
        });
    ...
    private void signOutUser() {
        Intent intent = new Intent(menu_profesor.this, login.class);
